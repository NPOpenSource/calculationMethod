...
#define RET_MALLOC_FAIL  (-3)
#define RET_PARAMS_ERROR (-4)
...
#define LogE_Iperf(...) __android_log_print(ANDROID_LOG_ERROR,"Iperf_log",__VA_ARGS__)
#define LogD_Iperf(...) __android_log_print(ANDROID_LOG_DEBUG,"Iperf_log",__VA_ARGS__)
